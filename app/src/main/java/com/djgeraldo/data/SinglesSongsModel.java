...
public class SinglesSongsModel {
    ...
    public SinglesSongsModel(String s_name, String s_duration, String s_url, String s_img, String s_artist, int s_id, int like_status, int total_likes, int nowPlaying) {
        this.s_name = s_name;
        this.s_id=s_id;
