...
public class MyPlayListSongs {
    ...
    public MyPlayListSongs(int sip_id,String s_name, String s_duration, String s_url, String s_img, String s_artist, int s_id,int like_status,int total_likes,int nowPlaying) {
        this.sip_id = sip_id;
        this.s_name = s_name;
        this.s_id=s_id;
    ...
    public void setSip_id(int sip_id) {
        this.sip_id = sip_id;
    }
