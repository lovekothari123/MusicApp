...
public class MyFavSongs {
    private String s_name;
    private String s_duration;
    private String s_url;
    private String s_img;
    private String s_artist;
    private int s_id,f_id;
    private int nowPlaying;
    private int total_likes;
    private int like_status;

    public MyFavSongs(int f_id,String s_name, String s_duration, String s_url, String s_img, String s_artist, int s_id,int like_status,int total_likes,int nowPlaying) {
        this.f_id = f_id;
        this.s_name = s_name;
        this.s_id=s_id;
