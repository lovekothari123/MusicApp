 ...
 */
public class LatinSingles extends Fragment {
    ...
    public LatinSingles(Context context, RelativeLayout header)
    {
    ...
    @SuppressLint("ValidFragment")
    public LatinSingles(Context context, RelativeLayout header,Boolean isOuter)
    {
        this.context = context;
        this.header = header;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,Bundle savedInstanceState) {
        ...
        View v = inflater.inflate(R.layout.fragment_latin_singles, container, false);
        latinRecycler = (RecyclerView)v.findViewById(R.id.latinRecycler);
        latinRecycler.setLayoutManager(new LinearLayoutManager(context));
        tv_title = header.findViewById(R.id.titleHeader);
        tv_title.setText("Latin Singles");
...
//        CustomHeader.setInnerFragment(getActivity(),header);
        ...
        Log.d("latin","Android id: "+androidId);
        Log.d("latin","Net is connected: "+isConnected);
    ...
    public void songLoaded(String url)
    {
        ...
        for (SinglesSongsModel s1: data)
        {
            ...
            latinRecycler.setAdapter(dataAdapter);
        }

    }

//    http://durisimomobileapps.net/djtico/api/songs/latinsingles
public class LatinAsync extends AsyncTask<String, Void, String> {

    final PojoSongForPlayer playingSong = MediaController.getInstance().getPlayingSongDetail();
    private JSONObject jsonObject;
    public LatinAsync(JSONObject jsonObject) {
...
//            String url = "http://durisimomobileapps.net/djtico/api/songs/latinsingles";
            String url = "http://durisimomobileapps.net/djgeraldo/api/songs/latinsingles";
    ...
    protected void onPostExecute(String s) {
        ...
        Log.d("Latin Songs", "Response is:" + s);
        if (!s.equals(null))
        {
            try {
                ...
                for (int i = 0; i < jsonArray.length(); i++) {
                    ...
                    Log.d("Latin songs", "Song Duration is: " + songDuration);
//                    dataArtist1.add(new Song(id,image,song,artistApi,songUrl,duration,likes,0,0,0,0));
                    ...
                    Log.d("Latin","NowPlaying: "+nowPlaying);
