...
import com.djgeraldo.adapter.MusicGenreSAdapter;
 ...
 */
public class MusicGenresSongs extends Fragment {
    ...
    MusicGenreSAdapter dataAdapter;
    RecyclerView genreSongs;
    SharedPreferences preferences;
    String androidId;
    boolean isConnected;

    public MusicGenresSongs() {
        // Required empty public constructor
    }

    @SuppressLint("ValidFragment")
    public MusicGenresSongs(Context context,int genre_id,String title, RelativeLayout header) {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View v = inflater.inflate(R.layout.fragment_music_genres_songs, container, false);
        genreSongs = (RecyclerView)v.findViewById(R.id.genreSongs);
        genreSongs.setLayoutManager(new LinearLayoutManager(context));
        Log.d("MG","Genre id is:"+genre_id);
        ...
        Log.d("genre songs","Android id: "+androidId);
        Log.d("genre songs","Net is connected: "+isConnected);
...
//        });
        ...
        {
            data.clear();
            new MusicGenreAsync(object).execute();
        }
        else
        {
    ...
    public void songLoaded(String url)
    {
        ...
        for (MusicGenreSongs s1: data)
        {
            ...
            MusicGenreSAdapter dataAdapter = new MusicGenreSAdapter(context,header,data);
            genreSongs.setAdapter(dataAdapter);
        }

    }

    //    http://durisimomobileapps.net/djtico/api/genre/songs
...
//                String url = "http://durisimomobileapps.net/djtico/api/genre/songs";
                String url = "http://durisimomobileapps.net/djgeraldo/api/genre/songs";
//                String url = "http://durisimomobileapps.net/djgeraldo/api/genre";
        ...
        protected void onPostExecute(String s) {
            ...
            Log.d("MusicGenre Songs", "Response is:" + s);
            if (s.equals(null)) {
                ...
                try {
                    ...
                    for (int i = 0; i < jsonArray.length(); i++) {
                        ...
                        Log.d("MusicGenre songs", "Song Duration is: " + songDuration);
//                    dataArtist1.add(new Song(id,image,song,artistApi,songUrl,duration,likes,0,0,0,0));
                        ...
                        Log.d("MusicGenre","NowPlaying: "+nowPlaying);
//                        String s_name, String s_duration, String s_url, String s_img, String s_artist, int s_id,int like_status,int total_likes,int nowPlaying
                        data.add(new MusicGenreSongs(songName,songDuration,songUrl,songImage,artist,songId,likeStatus,total,nowPlaying));

                    }
                    try {
                        dataAdapter = new MusicGenreSAdapter(context,header,data);
                        genreSongs.setAdapter(dataAdapter);
                    } catch (Exception e) {
                        e.printStackTrace();
                    }
