...
public class MusicPlayerService extends Service implements AudioManager.OnAudioFocusChangeListener, NotificationManager.NotificationCenterDelegate {
    ...
    public static final String NOTIFY_PREVIOUS = "com.djgeraldo.previous";
    public static final String NOTIFY_CLOSE = "com.djgeraldo.close";
    public static final String NOTIFY_PAUSE = "com.djgeraldo.pause";
    public static final String NOTIFY_PLAY = "com.djgeraldo.play";
    public static final String NOTIFY_NEXT = "com.djgeraldo.next";
    ...
    private void createNotification(PojoSongForPlayer mSongDetail) {
        try {
            ...
            if (albumArt != null) {
                ...
                notification.contentView.setImageViewResource(R.id.player_album_art, R.drawable.dj_gradlo_app_logo);
                if (supportBigNotifications) {
                    notification.bigContentView.setImageViewResource(R.id.player_album_art, R.drawable.dj_gradlo_app_logo);
                }
            }
