...
public class MusicPreferance {
    ...
    public static ArrayList<PojoSongForPlayer> playlist = new ArrayList<PojoSongForPlayer>();
    public static ArrayList<PojoSongForPlayer> shuffledPlaylist = new ArrayList<PojoSongForPlayer>();
    public static PojoSongForPlayer playingSongDetail;

    public static SharedPreferences getPreferanse(Context context) {
        return context.getSharedPreferences("BoogNasty", Activity.MODE_PRIVATE);
    }

    public static void saveLastSong(Context context, PojoSongForPlayer mDetail) {
    ...
    public static PojoSongForPlayer getLastSong(Context context) {
        if (playingSongDetail == null) {
            ...
            Gson mGson = new Gson();
            playingSongDetail = mGson.fromJson(lastplaySong, PojoSongForPlayer.class);
        }
    ...
    /*public static ArrayList<PojoSongForPlayer> getPlaylist(Context context) {
    ...
    public static ArrayList<PojoSongForPlayer> getPlaylist(Context context, String path) {
