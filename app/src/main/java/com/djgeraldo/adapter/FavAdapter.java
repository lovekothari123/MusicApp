...
public class FavAdapter extends RecyclerView.Adapter<FavAdapter.FavHolder> {
    ...
    public FavAdapter(Context context, RelativeLayout header,ArrayList<MyFavSongs> data)
    {
    ...
    @Override
    public FavAdapter.FavHolder onCreateViewHolder(ViewGroup parent, int viewType) {
    ...
    @Override
    public void onBindViewHolder(final FavAdapter.FavHolder holder, final int position) {
        ...
        final MyFavSongs currentData = data.get(position);
        final int fav_id = currentData.getF_id();
...
//                    object.put("likestatus",likeNos);
        ...
        holder.iv_options.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                try {
                    popupWindow(v,id,position,fav_id);
                } catch (JSONException e) {
                    e.printStackTrace();
                }
            }
...
//                                                            MainActivity.setLatinLayout();
    ...
    private void popupWindow(View view, final int id, final int position, final int favId) throws JSONException {
        ...
        favText.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (favId != 0)
                {
                    JSONObject object = new JSONObject();
                    try {
                        Log.d("FavAdapter","fav_id here:"+favId);
                        object.put("fav_id",favId);
                    } catch (JSONException e) {
                        e.printStackTrace();
                    }
...
//                String url = "http://durisimomobileapps.net/djtico/api/user/favourite/add";
    ...
    public class songLIkePostAsyncTask extends AsyncTask<String, Void, String> {
        ...
        TextView likeStatus;
        ImageView likeImage;
        MyFavSongs singlesSongsModel;
        public songLIkePostAsyncTask(MyFavSongs bean,JSONObject object,TextView likeStatus,ImageView likeImage) {
